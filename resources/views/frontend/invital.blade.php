                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="footer-item">
                            ...
                            <div class="d-flex flex-column align-items-start">
                                ...
                                <p><i class="fas fa-envelope text-primary me-2"></i> polije@gmail.com</p>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        <span class="text-light"><a href="#"><i class="fas fa-copyright text-light me-2"></i>ZhidarAugel</a>, All right reserved.</span>
                    </div>
